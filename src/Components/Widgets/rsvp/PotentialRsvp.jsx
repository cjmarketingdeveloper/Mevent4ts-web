...
function PotentialRsvp({user, CONSTANTS}) {
    ...
    const handlePersonalSave = async () => {
        try {
          ...
          if (pharmacyName !== user.details) {
            updateData.details = pharmacyName;
          }
        ...
        <div className="card-body">
          {editSection === "personal" ? (
            ...
            <>
              ...
              <p><strong>Pharmacy Name:</strong> {user.details}</p>
            </>
          )}
        </div>
      </div>
