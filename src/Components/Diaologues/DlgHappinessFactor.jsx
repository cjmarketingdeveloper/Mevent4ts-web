...
function DlgHappinessFactor({user, showModalHappiness, setShowModalHappiness}) {
    ...
    const isStepValid = () => {
        const validationMap = {
            ...
            6: ['q20', 'q21', 'q22'],
            7: ['q23', 'q24'],
            8: ['q25'], // If Yes, you'd add 'q24' dynamically here
            9: ['q27', 'q28', 'q29'],
            10: ['q32'] // Section 10/Final
        };
                ...
                <div className="step-body">
                    ...
                    step === 6 && (
                            <section>
                                ...
                                <div className="form-area-section-x1">
                                    ...
                                    <p className="mt-2">22) How would you rate the support received from your Clinic Advisor, and do they add value to your clinic operations?</p>
                                    <div className="custom-radio-group">
                                        <button className={`btn btn-opt mb-1 me-1 ${formData.q22 === 'Excellent – adds significant value' ? 'active' : ''}`} onClick={() => setFormData({...formData, q22: 'Excellent – adds significant value'})}>Excellent – adds significant value</button>
                                        <button className={`btn btn-opt mb-1 me-1 ${formData.q22 === 'Good – adds some value' ? 'active' : ''}`} onClick={() => setFormData({...formData, q22: 'Good – adds some value'})}>Good – adds some value</button>
                                        <button className={`btn btn-opt mb-1 me-1 ${formData.q22 === 'Average – limited value' ? 'active' : ''}`} onClick={() => setFormData({...formData, q22: 'Average – limited value'})}>Average – limited value</button>
                                        <button className={`btn btn-opt ${formData.q21 === 'Poor – no added value' ? 'active' : ''}`} onClick={() => setFormData({...formData, q22: 'Poor – no added value'})}>Poor – no added value </button>
                                    </div>
                    ...
                    step === 7 && (
                            <section>
                                ...
                                <p className="mt-2">24) Does the stockfile assist with purchasing efficiency and product selection?</p>
                                <div className="custom-radio-group">
                                    <button className={`btn btn-opt mb-1 me-1 ${formData.q24 === 'Yes – significantly' ? 'active' : ''}`} onClick={() => setFormData({...formData, q24: 'Yes – significantly'})}>Yes – significantly</button>
                                    <button className={`btn btn-opt mb-1 me-1 ${formData.q24 === 'Yes – somewhat' ? 'active' : ''}`} onClick={() => setFormData({...formData, q24: 'Yes – somewhat'})}>Yes – somewhat</button>
                                    <button className={`btn btn-opt mb-1 me-1 ${formData.q24 === 'Neutral' ? 'active' : ''}`} onClick={() => setFormData({...formData, q24: 'Neutral'})}>Neutral</button>
                    ...
                    step === 8 && (
                            <section>
                                ...
                                <div className="custom-radio-group">
                                    ...
                                    <button className={`btn btn-opt ${formData.q25 === 'No' ? 'active' : ''}`} onClick={() => setFormData({...formData, q25: 'No'})}>No</button>
                                </div>
                                    
                                {
                                    formData.q25 === "Yes" && <>
                                                                <p className="mt-2">26) How satisfied are you with the LocalEd training offering?</p>
                    ...
                    step === 9 && (
                            <section>
                                ...
                                <div className="form-area-section-x1">
                                    ...
                                    <p className="mt-3">28) <strong>Own Brand Products</strong> <br/>
                                        Do the own brand products meet your expectations?</p>
                                            <RatingScale name="q28" />    

                                    <p className="mt-3">29) <strong>Clothing / Uniform Solution</strong> <br/>
                                        Does the clothing and uniform solution meet your expectations?</p>
                                            <RatingScale name="q29" />           
                    ...
                    step === 10 && (
                            <section>
                                ...
                                <div className="form-area-section-x1">
                                    ...
                                    <p className="mt-2">31) Are there any additional services or support you would like to see introduced?</p>
                                        <textarea 
                                            className="form-control mt-2 fr-large" 
                                            rows="3"
                                            placeholder="Share your thoughts here..."
                                    ...
                                    <p className="mt-2">32) Overall, are you happy being part of The Local Choice franchise?</p>
                                        <div className="custom-radio-group">
                                            <button className={`btn btn-opt me-1 ${formData.q32 === 'Yes' ? 'active' : ''}`} onClick={() => setFormData({...formData, q32: 'Yes'})}>Yes</button>
                                            <button className={`btn btn-opt ${formData.q32 === 'No' ? 'active' : ''}`} onClick={() => setFormData({...formData, q32: 'No'})}>No</button>
                                        </div>
...
export default DlgHappinessFactor